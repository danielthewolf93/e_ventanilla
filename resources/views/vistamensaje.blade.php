...
<p style="text-align:center;">No hay datos adjuntos</p>
 ...
 <a href="{{ URL::previous() }}" class="btn btn-primary col-xs-2">Volver</a>
...
@endforeach
  ...
  <div class="col-xs-8"></div>
   ...
   <a href="{{ route('imprimir_msj',[$mode->id]) }}" class="btn btn-success col-xs-2" ><i class="glyphicon glyphicon-print"></i> Descargar</a> 
