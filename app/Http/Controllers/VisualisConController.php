...
public function index()
{
   ...
   $notifica= Notificaciones::where('id_recep','=',auth()->id())->where("notif_estado",'!=','baja')->orderBy('created_at','DSC')->paginate(10);
    ...
    return view('vistacontr',compact('notificaciones','notifica','notificacionesnleidas','notifleid','nombre','notifborradas','novedades'));
...
//--Listo faltaria imprimir un cartel que diga acceso no autorizado un alert una notif tipo toastr...algo
  
  if ($id_recept!=auth()->id()) {


    //mensaje avisando sobre el problema y redirijirlo a su lugar de origen o al mensaje previo que funcionaba y estaba leyendo.
    //
