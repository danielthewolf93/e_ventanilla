...
//
        ...
        $data = ['link' => 'https://rentas.catamarcaciudad.gob.ar/'];


        Mail::send('email.reports', $data, function ($ms) {
 
        $ms->from('contacto@rentasfc.gob.com.ar', 'Rentas Capital Catamarca');
 
        $ms->to('JuanPerez@gmail.com')->subject('Notificación');
