...
Route::get('/entorno_nuevo','SeguimientoNotifController@prueba')->name('toast');
...
//para envio de notificaciones via sms,wsp.
//Notificaciones via sms
Route::post('/enviosms','SeguimientoNotifController@enviosms')->name('envio_sms');
//Notificaciones via wsp
Route::get('/enviosmswsp','SeguimientoNotifController@enviosms_wsp')->name('envio_sms_wsp');
